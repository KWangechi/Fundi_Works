...
<h3>Delete details of a fundi</h3>

<form action="/fundidelete/{{ $role->id }}" method="POST" enctype="multipart/form-data">
...
<div>
<input type="file" name="image" required value="{{$fundi->image}}">
</div>
</div>
